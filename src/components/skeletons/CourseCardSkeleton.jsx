...
function CourseCardSkeleton() {
    return (
        <div className="flex flex-col rounded-xl overflow-hidden shadow-nova-md flex-none min-w-[280px] w-full h-full animate-pulse">
            ...
            <div className="flex flex-1/2 flex-col p-5 space-y-4">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    {/* Instructor */}
                    <div className="h-4 w-2/5 bg-gray-200 rounded-full" />
                </div>
